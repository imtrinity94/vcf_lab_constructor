###################################################################
# VCF Lab Constructor beta v4.2 2/10/2021
...
$host.ui.RawUI.WindowTitle = 'VCF Lab Constructor beta v4.2 - Process Window'
$welcomeText =@"
Welcome to:
...
Function compileDNSRecords
{
    ...
    $global:bringupOptions | Select -ExpandProperty nsxtSpec | Select -ExpandProperty nsxtEdgeSpec | Select -ExpandProperty edgeNodeSpecs | ForEach-Object -Process {$dnsFQDNs.Add($_.edgeNodeName,$($_.managementCidr).Split("/")[0])}
...
function setFormControls ($formway)
{
    ...
    switch ($formway)
    {
        ...
        'internalsvcs' {
                        ...
                        $lblBringUpFile.visible = $true
                        $txtBringUpFile.visible = $true
                        $txtBringUpFile.Text = "$scriptDir\AUTOMATED_AVN_VCF_VLAN_10-13_NOLIC_v42.json"
...
"@
        ...
        $frmVCFLCMain.Text = "VCF Lab Constructor beta 4.2"
